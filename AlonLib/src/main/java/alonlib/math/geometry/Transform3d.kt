 ...
 */
class Transform3d(val translation: Translation3d = Translation3d.Companion.kZero, val rotation: Rotation3d = Rotation3d.Companion.kZero) {
    ...
    operator fun plus(other: Transform3d) = Transform3d(Pose3d.Companion.kZero, Pose3d.Companion.kZero.transformBy(this).transformBy(other))

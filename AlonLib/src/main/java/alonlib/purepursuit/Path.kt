...
import alonlib.purepursuit.waypoints.EndWaypoint
import alonlib.purepursuit.waypoints.GeneralWaypoint
import alonlib.purepursuit.waypoints.InterruptWaypoint
import alonlib.purepursuit.waypoints.PointTurnWaypoint
import alonlib.purepursuit.waypoints.Waypoint
...
class Path(waypoints: List<Waypoint> = emptyList()) : ArrayList<Waypoint>(waypoints) {
	 ...
	 * waypoints, must start with a [alonlib.purepursuit.waypoints.StartWaypoint],
				...
				if (!tagged.hasTraversed) {
					...
					if (bestTagged !is PointTurnWaypoint) {
						...
						if (PurePursuitUtil.isInFront(
								this[intersection.waypointIndex - 1].pose.translation,
								tagged.pose.translation,

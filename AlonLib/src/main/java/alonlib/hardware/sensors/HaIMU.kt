...
class HaIMU(val imu: IMU) : HardwareDevice by imu {
	...
	/** Yaw as a [AngularPositon], the form the rest of AlonLib's geometry/odometry expects. */
	val angularPositon get() = AngularPositon.fromDegrees(imu.robotYawPitchRollAngles.getYaw(AngleUnit.DEGREES))

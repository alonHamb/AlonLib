 ...
 */
class HaColorSensor(val colorSensor: NormalizedColorSensor) : HardwareDevice by colorSensor {
	...
	val distance: Distance = (colorSensor as DistanceSensor).getDistance(DistanceUnit.METER).meters

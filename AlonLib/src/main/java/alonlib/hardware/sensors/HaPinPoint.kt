...
class HaPinPoint(var hardwareMap: HardwareMap, id: String, var pod: GoBildaOdometryPods) :
	 ...
	 */
	fun setOffset(xOffset: Distance, yOffset: Distance) {

package alonlib.drives

import alonlib.hardware.motors.HaMotor
import alonlib.math.geometry.Vector2d
...
class HaHDriveHa(
	...
	constructor(
		...
		right: HaMotor,
		slide: HaMotor,
		leftMotorAngleRadians: Double = DEFAULT_LEFT_MOTOR_ANGLE,
		rightMotorAngleRadians: Double = DEFAULT_RIGHT_MOTOR_ANGLE,
		slideMotorAngleRadians: Double = DEFAULT_SLIDE_MOTOR_ANGLE
	) :

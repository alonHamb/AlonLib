...
inline val Number.meters get() = Distance.fromMeters(this.toDouble())
inline val Number.centimeters get() = Distance.fromCentimeters(this.toDouble())
inline val Number.millimeters get() = Distance.fromMillimeters(this.toDouble())
inline val Number.feet get() = Distance.fromFeet(this.toDouble())
inline val Number.inches get() = Distance.fromInches(this.toDouble())

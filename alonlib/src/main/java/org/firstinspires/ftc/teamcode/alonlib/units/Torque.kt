...
class Torque(torque: Number, torqueUnit: Unit) : Comparable<Torque> {
	...
	operator fun times(other: Torque) = fromNewtonMeters(newtonMeters * other.newtonMeters)
	operator fun times(scalar: Number) = fromNewtonMeters(newtonMeters * scalar.toDouble())
	operator fun div(other: Torque) = fromNewtonMeters(newtonMeters / other.newtonMeters)
	operator fun div(scalar: Number) = fromNewtonMeters(newtonMeters / scalar.toDouble())

 ...
 *
 * Not clamped to any range by this class itself -- callers (like [org.firstinspires.ftc.teamcode.alonlib.hardware.motors.HaMotor])
...
class Percentage(percentage: Number, percentageUnit: Unit) : Comparable<Percentage> {
    ...
    operator fun times(scalar: Double) = fromFraction(fraction * scalar)
    operator fun div(scalar: Double) = fromFraction(fraction / scalar)

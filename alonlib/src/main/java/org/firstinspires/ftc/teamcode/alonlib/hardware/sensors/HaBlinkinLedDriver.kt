...
class HaBlinkinLedDriver(val blinkin: RevBlinkinLedDriver) : com.qualcomm.robotcore.hardware.HardwareDevice by blinkin {
    ...
    var pattern: RevBlinkinLedDriver.BlinkinPattern? = null
        set(value) {
            field = value
            if (value != null) blinkin.setPattern(value)
        }
}

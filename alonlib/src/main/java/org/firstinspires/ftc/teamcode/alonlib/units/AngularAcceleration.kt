...
class AngularAcceleration(acceleration: Number, accelerationUnit: Unit) : Comparable<AngularAcceleration> {
	...
	operator fun times(other: AngularAcceleration) = fromRadiansPerSecondSquared(radiansPerSecondSquared * other.radiansPerSecondSquared)
	operator fun times(scalar: Double) = fromRadiansPerSecondSquared(radiansPerSecondSquared * scalar)
	operator fun div(other: AngularAcceleration) = fromRadiansPerSecondSquared(radiansPerSecondSquared / other.radiansPerSecondSquared)

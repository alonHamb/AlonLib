...
/** A raw analog input pin (e.g. a potentiometer or an absolute-encoder feedback wire) -- see [org.firstinspires.ftc.teamcode.alonlib.hardware.AbsoluteAnalogEncoder] for the normalized-angle version. */
